...
MileStream addresses two linked problems:

1. **Clients don't trust strangers.** Freelancers deliver work and never get paid.
2. **Credentials are fakeable.** "Verified" badges cost nothing to spam.
...
A freelancer profile on informal platforms costs nothing to create. Bots and scammers spin up infinite identities.

MileStream is different.

- Each credential exists because a PoW-mined HACD was committed as its container.
- Each lot required 50 HAC as an on-chain formation cost.
- Each Contractor ID is a unique 6-letter HACD name, permanently recorded on-chain.
- Supply is capped at 200 founding contractors.

Bitcoin proved PoW for money. HACD brings PoW to assets. MileStream brings it to freelancer trust.

## The hybrid: MSTR + Contractor ID

One Stack action gives you two linked things:

- **MSTR** — fungible credential balance. 5,000 MSTR per lot.
- **Contractor ID** — your unique 6-letter HACD name.
...
## Pilot phase (first 20 lots)

The first 20 lots are reserved for onboarding-approved pilot contractors during phase 1.

**How it works:** Each approved pilot stacks **directly on Launchpad in their own wallet** (1–5 HACD lots per participant, up to 20 lots total in phase 1). The issuer does **not** stack on behalf of pilots through the designated address.

To join the pilot phase, contact the issuer at itsarko619@gmail.com before stacking.

## How Stack works

1. Complete pilot onboarding with the issuer (phase 1) or wait for the public phase (phase 2).
2. Bring 1–5 HACD units. Their names become your Contractor IDs.
3. Bring enough HAC: (number of HACD) × 50 HAC + network fee.
4. Confirm a Stack transaction on https://hacd.it/launchpad.
5. Verify formation on explorer.hacash.org.

## Formation rules

- Total HACD lots: 200 (20 pilot + 180 public)
- Units per lot: 5,000 MSTR
- Contractor IDs: up to 200
- Stack cost: 50 HAC per HACD
- Total supply cap: 1,000,000 MSTR
- Minimum per participant: 1 HACD
- Maximum per participant: 5 HACD

## Launch details

- Target date: 2026-07-15
- Platform: https://hacd.it/launchpad
- Phase: designated first (20 pilot lots — direct stacking by approved pilots) then public (180 lots)
...
Yes. Each Stack lot requires 1 HACD.
...
Final parameters must be confirmed by Arko Roy and reviewed by HACD Labs before publication.
