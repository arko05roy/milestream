...
| Phase | Lots | Who | How |
|-------|------|-----|-----|
| First phase | 20 | Onboarding-approved pilot contractors | Each pilot stacks **directly on Launchpad in their own wallet** (1–5 HACD per participant) |
| Public phase | 180 | Qualified freelancers | Open stacking after pilot validation |

Phase lot sum: 20 + 180 = 200 ✓

**Pilot clarification:** The first 20 lots are capacity-reserved for approved pilots during phase 1. The designated address (`1C9883DEKbLKLfxmdavGJq6nr8MVe6LS6V`) is the issuer's coordination wallet for pilot intake and Launchpad phase routing. The issuer does **not** stack HACD on behalf of pilots.
